...
from utils.geometry import mat2pose_vec, pose_vec2mat, warp_features
...
def convert_instance_mask_to_center_and_offset_label(instance_img, future_egomotion, num_instances, ignore_index=255,
    ...
    for t in range(1, seq_len):
        ...
        # debug ---
        # cur_scene = toNP(instance_img[t - 1].squeeze())
        # next_scene = toNP(instance_img[t].squeeze())
        # next2cur_scene = toNP(warped_inst_t.squeeze())
        # plt.imshow(cur_scene)
        # plt.show()
        # plt.imshow(cur_scene-next2cur_scene)
        # plt.show()
        # debug ---
    ...
    for instance_id in range(1, num_instances+1):
        ...
        for t in range(seq_len):
            ...
            # center_label has gaussian shape
